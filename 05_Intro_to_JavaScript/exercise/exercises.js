...
*/
		function hasTeen(a, b, c){
				if(a >= 13 && a<= 19 ||  b >= 13 && b<= 19 ||  c >= 13 && c <= 19){
					return true;
				} else if (a >= 13 && a<= 19 && b >= 13 && b<= 19 || a >= 13 && a<= 19 && c >= 13 && c <= 19 || c >= 13 && c <= 19 && b >= 13 && b<= 19 ){
				return true;	
...
6. **frontAgain** Given a string, return true if the first 2 chars in the string also appear 
    at the end of the string, such as with "edited".
		...
		frontAgain("ed") → true
*/
		function frontAgain(ch){
			return ch.substring(0,2) == ch.substring(ch.length-2);
		}
...
*/
		function cigarParty(num, isWeekend){
			return num >= 40 && num <= 60 && !isWeekend || num >= 40 && isWeekend;
		}
...
*/
	function createObject(){
		const person = {firstName: 'Tom', lastName: 'Kid', age: 21};
		return person;
	}
